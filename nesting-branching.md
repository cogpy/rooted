...
* **Nesting** (or **serial chain**) = the *chain-like* operation (temporal / serial / prime / irreducible / one)
* **Branching** (or **parallel product**) = the *product-like* operation (spatial / concurrent / composite / reducible / many)
